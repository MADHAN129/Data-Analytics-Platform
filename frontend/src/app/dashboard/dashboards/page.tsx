...
function AutoGenerateDialog({
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      toast({ title: "Dashboard generated", description: "AI analyzed schema and generated pie charts, bar charts, and data tables.", variant: "success" })
      onOpenChange(false)
      onSuccess(dash.id)
    } catch {
      ...
      <DialogContent className="sm:max-w-[480px]">
        ...
        <div className="space-y-4 py-2">
          <p className="text-sm text-muted-foreground">
            Select a database. AI will automatically analyze the database schema and generate a full dashboard with pie charts, bar charts, and data tables without requiring any manual topics.
          </p>
          ...
          <div className="rounded-lg border bg-muted/40 p-3.5 space-y-2.5">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="flex flex-col items-center justify-center rounded-md border bg-background p-2.5 text-center shadow-xs">
                ...
                <span className="text-[10px] text-muted-foreground leading-tight mt-0.5">Distributions</span>
              </div>
              <div className="flex flex-col items-center justify-center rounded-md border bg-background p-2.5 text-center shadow-xs">
                <BarChart3 className="h-5 w-5 text-blue-500 mb-1" />
                <span className="text-xs font-medium">Bar Chart</span>
                <span className="text-[10px] text-muted-foreground leading-tight mt-0.5">Metrics & Ranks</span>
              </div>
              <div className="flex flex-col items-center justify-center rounded-md border bg-background p-2.5 text-center shadow-xs">
                <Table2 className="h-5 w-5 text-purple-500 mb-1" />
                <span className="text-xs font-medium">Data Table</span>
                <span className="text-[10px] text-muted-foreground leading-tight mt-0.5">Top Records</span>
              </div>
            </div>
          </div>
        </div>
