...
def friendly_error(raw: str) -> str:
    ...
    # If raw is a schema validation error or database diagnostic, keep the detailed message!
    if any(prefix in raw for prefix in ("SQL Validation Error", "Column '", "Table '", "Invalid JOIN", "Row Multiplication", "Oracle SQL error", "ORA-")):
    ...
    patterns = [
        ...
        (r"Unknown database|database.*does not exist", "The specified database was not found. Check the database name."),
